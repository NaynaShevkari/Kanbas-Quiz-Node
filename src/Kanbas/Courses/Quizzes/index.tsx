        ...
        <li className='list-group-item'>
          ...
          <div id='wd-quiz-list' className='list-group rounded-0'>
            {filteredQuizzes.map((quiz: any) => {
              ...
              const totalQuestions = new Date(quiz.numQuestions)
                  ...
                  <div className='d-flex align-items-center'>
                    ...
                    <div className='flex-grow-1'>
                      ...
                      <span className='wd-quiz-details'>
                        ...
                        {/* <strong> {quiz.points || 'None'}</strong> pts | */}
                         <br/> Questions: <strong> {quiz.numQuestions }</strong>  |
                        Total Points :<strong> {quiz.points || 'None'}</strong>
                      </span>
                    </div>
                    {userRole === 'FACULTY' && (
